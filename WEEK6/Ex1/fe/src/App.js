...
const pusher = new Pusher('e8529aa2dbd0bc60799f', {
  cluster: 'ap2'
}); 
  ...
  return (
    <div className="app">
      ...
      <div className='app__header'>
        <img className='app__headerImage' src='https://png.pngtree.com/png-clipart/20190515/original/pngtree-coffee-time-png-image_3626459.jpg' alt='Header'/>
